...
namespace FSI.SupportPointSystem.Domain.Entities
{
    public class Customer
    {
        ...
        public Customer(Guid id, string companyName, Cnpj cnpj, Address address, Coordinates locationTarget)
        {
        ...
        {
            Address = newAddress ?? throw new DomainException("O endereço não pode ser nulo.");
        }
